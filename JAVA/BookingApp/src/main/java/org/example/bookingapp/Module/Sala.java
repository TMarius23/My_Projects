...
public class Sala {
   ...
   public Sala(String name, String description, int nrDeInchirieri, double price, boolean inchiriata, TipSala tipSala, int idRef, List<Rezervare> dataInchiriere, String imagine) {
        this.name = name;
        this.description = description;
        this.nrDeInchirieri = nrDeInchirieri;
        this.price = price;
    ...
    public Sala(String name, String description, int nrDeInchirieri, double price, boolean inchiriata, TipSala tipSala, int idRef, String imagine) {
        this.name = name;
        this.description = description;
        this.nrDeInchirieri = nrDeInchirieri;
        this.price = price;
