...
design_libs=(xpm axis_infrastructure_v1_1_1 axis_data_fifo_v2_0_13 xil_defaultlib)
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../AXIS4-STREAM.gen/sources_1/ip/axis_data_fifo_0/hdl" \
  ...
  vlogan -work axis_infrastructure_v1_1_1 $vlogan_opts +v2k +incdir+"../../../AXIS4-STREAM.gen/sources_1/ip/axis_data_fifo_0/hdl" \
  "../../ipstatic/hdl/axis_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axis_data_fifo_v2_0_13 $vlogan_opts +v2k +incdir+"../../../AXIS4-STREAM.gen/sources_1/ip/axis_data_fifo_0/hdl" \
  "../../ipstatic/hdl/axis_data_fifo_v2_0_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../AXIS4-STREAM.gen/sources_1/ip/axis_data_fifo_0/hdl" \
