...
#
# Script generated by Vivado on Wed Oct 08 18:48:46 +0300 2025
...
design_libs_elab="-libname xpm -libname axis_infrastructure_v1_1_1 -libname axis_data_fifo_v2_0_13 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm axis_infrastructure_v1_1_1 axis_data_fifo_v2_0_13 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "top.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../AXIS4-STREAM.gen/sources_1/ip/axis_data_fifo_0/hdl" \
  ...
  xmvlog -work axis_infrastructure_v1_1_1 $xmvlog_opts +incdir+"../../../AXIS4-STREAM.gen/sources_1/ip/axis_data_fifo_0/hdl" \
  "../../ipstatic/hdl/axis_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axis_data_fifo_v2_0_13 $xmvlog_opts +incdir+"../../../AXIS4-STREAM.gen/sources_1/ip/axis_data_fifo_0/hdl" \
  "../../ipstatic/hdl/axis_data_fifo_v2_0_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../AXIS4-STREAM.gen/sources_1/ip/axis_data_fifo_0/hdl" \
