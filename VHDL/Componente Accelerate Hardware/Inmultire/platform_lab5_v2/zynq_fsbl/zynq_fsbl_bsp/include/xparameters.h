...
/* Definitions for peripheral AXI_GPIO_GATA */
#define XPAR_AXI_GPIO_GATA_COMPATIBLE "xlnx,axi-gpio-2.0"
#define XPAR_AXI_GPIO_GATA_BASEADDR 0x41280000
#define XPAR_AXI_GPIO_GATA_HIGHADDR 0x4128ffff
#define XPAR_AXI_GPIO_GATA_INTERRUPT_PRESENT 0x1
#define XPAR_AXI_GPIO_GATA_IS_DUAL 0x0
#define XPAR_AXI_GPIO_GATA_GPIO_WIDTH 0x1

/* Canonical definitions for peripheral AXI_GPIO_GATA */
#define XPAR_XGPIO_1_BASEADDR 0x41280000
#define XPAR_XGPIO_1_HIGHADDR 0x4128ffff
...
/* Definitions for peripheral AXI_GPIO_OPERANDA */
#define XPAR_AXI_GPIO_OPERANDA_COMPATIBLE "xlnx,axi-gpio-2.0"
#define XPAR_AXI_GPIO_OPERANDA_BASEADDR 0x41230000
#define XPAR_AXI_GPIO_OPERANDA_HIGHADDR 0x4123ffff
#define XPAR_AXI_GPIO_OPERANDA_INTERRUPT_PRESENT 0x0
#define XPAR_AXI_GPIO_OPERANDA_IS_DUAL 0x0
#define XPAR_AXI_GPIO_OPERANDA_GPIO_WIDTH 0x4

/* Canonical definitions for peripheral AXI_GPIO_OPERANDA */
...
/* Definitions for peripheral AXI_GPIO_OPERANDB */
#define XPAR_AXI_GPIO_OPERANDB_COMPATIBLE "xlnx,axi-gpio-2.0"
#define XPAR_AXI_GPIO_OPERANDB_BASEADDR 0x41240000
#define XPAR_AXI_GPIO_OPERANDB_HIGHADDR 0x4124ffff
#define XPAR_AXI_GPIO_OPERANDB_INTERRUPT_PRESENT 0x0
#define XPAR_AXI_GPIO_OPERANDB_IS_DUAL 0x0
#define XPAR_AXI_GPIO_OPERANDB_GPIO_WIDTH 0x4

/* Canonical definitions for peripheral AXI_GPIO_OPERANDB */
...
/* Definitions for peripheral AXI_GPIO_RESETARE */
#define XPAR_AXI_GPIO_RESETARE_COMPATIBLE "xlnx,axi-gpio-2.0"
#define XPAR_AXI_GPIO_RESETARE_BASEADDR 0x41250000
#define XPAR_AXI_GPIO_RESETARE_HIGHADDR 0x4125ffff
#define XPAR_AXI_GPIO_RESETARE_INTERRUPT_PRESENT 0x0
#define XPAR_AXI_GPIO_RESETARE_IS_DUAL 0x0
#define XPAR_AXI_GPIO_RESETARE_GPIO_WIDTH 0x1

/* Canonical definitions for peripheral AXI_GPIO_RESETARE */
...
#define XPAR_AXI_GPIO_REZ_BASEADDR 0x41260000
#define XPAR_AXI_GPIO_REZ_HIGHADDR 0x4126ffff
#define XPAR_AXI_GPIO_REZ_INTERRUPT_PRESENT 0x0
#define XPAR_AXI_GPIO_REZ_IS_DUAL 0x0
#define XPAR_AXI_GPIO_REZ_GPIO_WIDTH 0x9
...
#define XPAR_XGPIO_6_GPIO_WIDTH 0x9
#define XPAR_XGPIO_6_INTERRUPT_PRESENT 0x0
#define XPAR_XGPIO_6_IS_DUAL 0x0

/* Definitions for peripheral AXI_GPIO_STARTBIT */
#define XPAR_AXI_GPIO_STARTBIT_COMPATIBLE "xlnx,axi-gpio-2.0"
#define XPAR_AXI_GPIO_STARTBIT_BASEADDR 0x41270000
#define XPAR_AXI_GPIO_STARTBIT_HIGHADDR 0x4127ffff
#define XPAR_AXI_GPIO_STARTBIT_INTERRUPT_PRESENT 0x0
#define XPAR_AXI_GPIO_STARTBIT_IS_DUAL 0x0
#define XPAR_AXI_GPIO_STARTBIT_GPIO_WIDTH 0x1

/* Canonical definitions for peripheral AXI_GPIO_STARTBIT */
...
#define XPAR_AXI_GPIO_SW_GPIO_WIDTH 0x4

/* Canonical definitions for peripheral AXI_GPIO_SW */
#define XPAR_XGPIO_8_BASEADDR 0x41220000
#define XPAR_XGPIO_8_HIGHADDR 0x4122ffff
#define XPAR_XGPIO_8_COMPATIBLE "xlnx,axi-gpio-2.0"
#define XPAR_XGPIO_8_GPIO_WIDTH 0x4
